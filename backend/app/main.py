...
async def generate_advice(
    ...
    model_response = client.chat.completions.create(
        messages=[
            {
                "role": "developer",
                "content": "Δωσε φορολογικες συμβουλες στον χρηστη. Οι απαντησεις σου να ειναι περιεκτικες και επι του θεματος. Αμα ο χρηστης στο prompt του ρωταει κατι που δεν εχει σχεση με τη φορολογια μην απαντησεις και ενημερωσε ευγενικα οτι ο ρολος σου δεν ειναι αυτος. Για οσα γνωριζεις για την ελληνικη φορολογια θα πρεπει να ενημερωσεις τον χρηστη με τη μορφη συμβουλης.",
            },
            {
                "role": "user",
                "content": f"Δωσε μου φορολογικες πληροφοριες και συμβουλες με βαση το προηγουμενο prompt του χρηστη και τα παρακατω: {info}",
            },
        ],
        model="gpt-4o",
    )
